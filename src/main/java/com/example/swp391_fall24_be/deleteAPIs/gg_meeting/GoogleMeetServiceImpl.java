...
public class GoogleMeetServiceImpl implements GoogleMeetService {
    ...
    private static final String CREDENTIALS_FILE_PATH = "com/example/swp391_fall24_be/deleteAPIs/credentials.json";
    ...
    public String getAuthorizationUrl() throws IOException, GeneralSecurityException {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(getClass().getResourceAsStream("/com/example/swp391_fall24_be/deleteAPIs/credentials.json")));
    ...
    public String getAccessToken(String authCode) throws IOException, GeneralSecurityException {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(getClass().getResourceAsStream("/com/example/swp391_fall24_be/deleteAPIs/credentials.json")));
