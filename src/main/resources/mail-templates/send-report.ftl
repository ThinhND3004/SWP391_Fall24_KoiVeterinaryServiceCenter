...
<body style="
      ...
      margin: 0;
    ">
<div dir="ltr" class="es-wrapper-color" lang="vi" style="background-color: #f9f4ff">
    <!--[if gte mso 9]>
    <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
        <v:fill
                type="tile"
                src="https://ebfjyum.stripocdn.email/content/guids/CABINET_b5bfed0b11252243ebfb1c00df0e3977/images/rectangle_171_3.png"
                color="null"
        ></v:fill>
    </v:background>
    <![endif]-->
    <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
           background="https://ebfjyum.stripocdn.email/content/guids/CABINET_b5bfed0b11252243ebfb1c00df0e3977/images/rectangle_171_3.png"
           style="
          ...
          width: 100%;
          height: 100%;
          background-image: url(https://ebfjyum.stripocdn.email/content/guids/CABINET_b5bfed0b11252243ebfb1c00df0e3977/images/rectangle_171_3.png);
                          ...
                          ">
                                ...
                                ">
                                    ...
                                    ">
                                        ...
                                        font-size: 16px;
                                      "><img
                                                                            src="https://www.yourcentralvalley.com/wp-content/uploads/sites/54/2023/09/Koi-Fish-Show-returns-to-Fresno-at-Woodward-Park.jpeg?w=2560&h=1440&crop=1"
                                                                            alt style="
                                          display: block;
                                          border: 0;
                                          outline: none;
                                  ...
                                  border-color: #4ca2f8;
                                  border-radius: 20px;
                                  background-image: url(https://ebfjyum.stripocdn.email/content/guids/CABINET_9aa36f49cdb5185ad35ee0f7a5c7d9380ade3ae69ada3493ecaa145d1284bee9/images/group_347_1.png);
                                ...
                                "
                                    ...
                                    <span style="
                                        ...
                                        "><span style="color: #ffffff"><strong>Dear
                                    ...
                                    <span style="
                                          font-family: roboto, 'helvetica neue',
                                            helvetica, arial, sans-serif;
                                        "><span style="color: #ffffff"> Your report for service ${serviceName}
                                            which was done at ${startedAt}!
                                            by : ${veterianName}
                                            For viewing the report, please go to: ${companyWebsite}
                                      </span></span>
<#--                                                                </p>-->
<#--                                                                <p style="-->
<#--                                        color: #ffffff;-->
...
<#--                                        </table>-->
              ...
              ">
                    ...
                    ">
                                <tr>
                                    <td align="left"
                                        background="https://ebfjyum.stripocdn.email/content/guids/CABINET_b5bfed0b11252243ebfb1c00df0e3977/images/20347363_v1072014converted_1_GkL.png"
                                        style="
                          padding: 0;
                          margin: 0;
                          padding-top: 20px;
                          padding-left: 40px;
                          padding-right: 40px;
                          background-image: url(https://ebfjyum.stripocdn.email/content/guids/CABINET_b5bfed0b11252243ebfb1c00df0e3977/images/20347363_v1072014converted_1_GkL.png);
                          background-repeat: no-repeat;
                        ...
                        ">
                          ...
                          ">
                                ...
                                ">
                                                        <tr>
                                                            <td align="left" class="es-m-p0l" style="
                                      padding: 0;
                                      margin: 0;
                                      padding-left: 40px;
                                      font-size: 0px;
                                    ">
                                                        ...
                                                        <tr>
                                                            <td align="left" class="es-m-p0r es-m-p0l" style="
                                      padding: 0;
                                      margin: 0;
                                      padding-top: 20px;
                                      padding-left: 40px;
                                ...
                                <tr>
                                    <td class="es-m-p40l" align="left" style="
                          padding: 0;
                          margin: 0;
                          padding-left: 20px;
                          padding-bottom: 40px;
